...
public class MigrationHelper {
    ...
    private static final String CONVERSION_CLASS_NOT_FOUND_EXCEPTION = "MIGRATION HELPER - CLASS DOESN'T"
            + " MATCH WITH THE CURRENT PARAMETERS";
...
//
        ...
        for (int i = 0; i < daoClasses.length; i++) {
            ...
            for (int j = 0; j < daoConfig.properties.length; j++) {
                ...
                if (getColumns(db, tableName).contains(columnName)) {
                    ...
                    createTableStringBuilder.append(divider).append(columnName)
                            .append(" ").append(type);
    ...
    private void restoreData(Database db,
        ...
        for (int i = 0; i < daoClasses.length; i++) {
            ...
            insertTableStringBuilder.append("INSERT INTO ").append(tableName)
                    .append(" (");
            insertTableStringBuilder.append(TextUtils.join(",", properties));
            insertTableStringBuilder.append(") SELECT ");
            insertTableStringBuilder.append(TextUtils.join(",", properties));
